...
$expectations = array(
    ...
    'packages/itk-commerce-documents/src/BarcodeService.php' => array( 'Code 39', "'*' . $value . '*'", '<svg', 'itk-document-barcode' ),
    'packages/itk-commerce-documents/src/BatchPackingService.php' => array( 'MAX_ORDERS', 'itk_commerce_packing_location', 'Consolidated picking list', '_itk_warehouse_location' ),
    'packages/itk-commerce-documents/src/DocumentExtensions.php' => array( 'itk_commerce_document_code_markup', 'admin_post_itk_commerce_batch_packing', 'itk_manage_documents' ),
    'packages/itk-commerce-documents/src/DocumentsModule.php' => array( 'itk_manage_documents', 'admin_post_itk_commerce_generate_document', 'woocommerce_email_attachments', 'woocommerce_order_details_after_order_table', 'itk_commerce_order_language_scope' ),
    'packages/itk-commerce-elementor/src/ElementorModule.php' => array( 'elementor/widgets/register', 'elementor/dynamic_tags/register', 'ProductsWidget', 'ProductCategoriesWidget', 'ProductFilterWidget', 'ProductSearchWidget', 'HeroBannerWidget', 'BranchesWidget', 'ReviewsWidget', 'ContactWidget', 'MiniCartWidget', 'LanguageSwitcherWidget', 'MenuWidget' ),
    'packages/itk-commerce-elementor/src/DynamicTags.php' => array( 'product-sku', 'product-price', 'product-stock', 'current-language', 'contact-email' ),
    'packages/itk-commerce-theme/inc/elementor.php' => array( "'single'", "'archive'", "'itk-before-header'", "'itk-before-content'", "'itk-before-footer'" ),
    'packages/itk-commerce-core/src/Design/LocalFonts.php' => array( 'itk_commerce_local_fonts', 'upload_mimes', 'wp_enqueue_media', '@font-face', 'font-display:swap', 'itk_manage_design' ),
    'packages/itk-commerce-code-manager/src/SnippetRepository.php' => array( 'TOKEN_PARSE', 'versions', 'audit', 'set_enabled', 'rollback', 'enabled' ),
