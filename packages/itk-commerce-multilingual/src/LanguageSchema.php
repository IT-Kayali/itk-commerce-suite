...
final class LanguageSchema {
    /**
     * Return a neutral single-language configuration from the WordPress locale.
     *
    ...
    /**
     * Normalize one customer/profile language configuration.
     *
    ...
    /**
     * @param mixed $language Raw language row.
    ...
    /**
     * Normalize a public URL language code to a short lowercase slug.
     *
    ...
    /**
     * Normalize a WordPress-style locale while preventing arbitrary strings.
     *
    ...
    /**
     * Conservative default direction. Customer/profile config remains authoritative.
     *
