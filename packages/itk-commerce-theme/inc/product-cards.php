...
/**
 * Render optional semantic product-card action slots only when an integration
 * actually attaches. Quick View, Wishlist and Compare have dedicated contracts;
 * the original general action remains supported last for backwards compatibility.
 *
 * @return void
 */
